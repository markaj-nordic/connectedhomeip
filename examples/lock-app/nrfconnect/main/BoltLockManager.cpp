                              ...
                              CredentialRuleEnum credentialRule, const CredentialStruct * credentials, size_t totalCredentials)
{
    ...
    for (size_t i = 0; i < totalCredentials; ++i)
    {
        ...
        case CredentialTypeEnum::kPin:
            ...
            // Ideally this could just reference the address instead of copying the data, but we need a sequential block of
            // CredentialStruct to be compatible with chip::Span API. The same applies in below cases.
        ...
        case CredentialTypeEnum::kFingerVein:
            ...
            memcpy(&userData.mCredentials.mFingerPrint[fpIdx], currentCredentials, sizeof(CredentialStruct));
...
EmberAfPluginDoorLockCredentialInfo * BoltLockManager::GetCredentialsOfType(CredentialTypeEnum type, uint16_t credentialIndex) const
{
...
BoltLockManager::CredentialData * BoltLockManager::GetCredentialsDataOfType(CredentialTypeEnum type, uint16_t credentialIndex) const
{
